...
# Android's verified egress, runtime DNS, bounded discovery, WireGuard runtime,
# H3 lifecycle, and fresh runtime policy in the same order as the local build.
patches=(
  ...
  "scripts/ci/patch-aether-wg-post-handshake-junk.py"
